...
public class MyHandAdapter extends BaseAdapter {
	...
	public MyHandAdapter(Context context, List<MinelaunchInfo> datas) {
		super();
	...
	public View getView(int position, View conVertView, ViewGroup parent) {
		...
		if (layout == null) {
			...
			layout = inflater.inflate(R.layout.mine_hand_listitem, null);
			ViewHolder hold = new ViewHolder();
			hold.tvusername = (TextView) layout
					.findViewById(R.id.mine_hand_username);
			hold.publishtime = (TextView) layout
					.findViewById(R.id.mine_hand_time);
			hold.projecttitle = (TextView) layout
					.findViewById(R.id.mine_hand_title);
			hold.describe = (TextView) layout
					.findViewById(R.id.mine_hand_content);
			layout.setTag(hold);
		}
