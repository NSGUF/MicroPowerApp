...
import com.mine.adapter.MyDonateAdapter;
import com.mine.bean.MinelaunchInfo;
import com.mine.bean.PullDownView;
import com.mine.bean.PullDownView.OnPullDownListener;

public class MineDonateActivity extends Activity implements OnClickListener,
		OnPullDownListener, OnItemClickListener {
	private static final int WHAT_DID_LOAD_DATA = 0;
	private static final int WHAT_DID_REFRESH = 1;
	private static final int WHAT_DID_MORE = 2;
	private ListView mListView;
	private ImageView ib_minedonate_left;
	private Button btn_donate_all, btn_donate_raise, btn_donate_end;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mine_activity_donate);
		mPullDownView = (PullDownView) findViewById(R.id.pull_down_view);
		mPullDownView.setOnPullDownListener(this);
		mListView = mPullDownView.getListView();

		ib_minedonate_left = (ImageView) findViewById(R.id.ib_minedonate_left);
		btn_donate_all = (Button) findViewById(R.id.btn_donate_all);
		btn_donate_raise = (Button) findViewById(R.id.btn_donate_raise);
		btn_donate_end = (Button) findViewById(R.id.btn_donate_end);
		btn_donate_all.setOnClickListener(this);
		btn_donate_raise.setOnClickListener(this);
		btn_donate_end.setOnClickListener(this);

		itemUsernames = getResources().getStringArray(R.array.myusernames);
		itemPublishtimes = getResources().getStringArray(
				R.array.mydonatepublishtimes);
		itemTitles = getResources().getStringArray(R.array.mydonatetitles);
		itemDescribes = getResources()
				.getStringArray(R.array.mydonatedescribes);
		datas = getList();
		adapter = new MyDonateAdapter(MineDonateActivity.this, datas);
		mListView.setAdapter(adapter);
		mPullDownView.enableAutoFetchMore(true, 1);
		loadData();
		// ����
		ib_minedonate_left.setOnClickListener(new OnClickListener() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(MineDonateActivity.this,
						MineDonateItemDetailActivity.class);
	...
	public void onClick(View v) {
		// TODO Auto-generated method stub
		switch (v.getId()) {
		case R.id.btn_donate_all:
			btn_donate_all
					.setBackgroundResource(R.drawable.click_button_select);
			btn_donate_raise
					.setBackgroundResource(R.drawable.click_button_nomal);
			btn_donate_end.setBackgroundResource(R.drawable.click_button_nomal);
			break;
		case R.id.btn_donate_raise:
			btn_donate_raise
					.setBackgroundResource(R.drawable.click_button_select);
			btn_donate_all.setBackgroundResource(R.drawable.click_button_nomal);
			btn_donate_end.setBackgroundResource(R.drawable.click_button_nomal);
			break;
		case R.id.btn_donate_end:
			btn_donate_end
					.setBackgroundResource(R.drawable.click_button_select);
			btn_donate_all.setBackgroundResource(R.drawable.click_button_nomal);
			btn_donate_raise
