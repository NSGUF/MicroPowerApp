...
public class AlbumGridViewAdapter extends BaseAdapter {
	...
	private ArrayList selectedDataList;
	...
	public AlbumGridViewAdapter(Context c, ArrayList<ImageItem> dataList,
			ArrayList selectedDataList,GridView mGridView) {
...
//			RelativeLayout.LayoutParams params = (android.widget.RelativeLayout.LayoutParams) viewHolder.imageView
//					.getLayoutParams();
